...
import com.bigtreetc.recycling.aws.client.ses.AwsSesConfigProperty;
...
public class AwsClientConfig {
  ...
  public SqsClient sqsClient(
      AwsSqsConfigProperty properties, AwsCredentialsProvider awsCredentialsProvider) {
    val region = Region.AP_NORTHEAST_1;
  ...
  public SesClient sesClient(
      AwsSesConfigProperty properties, AwsCredentialsProvider awsCredentialsProvider) {
    val region = Region.AP_NORTHEAST_1;
    val builder = SesClient.builder().credentialsProvider(awsCredentialsProvider).region(region);
    if (properties.getEndpoint() != null) {
      val endpoint = properties.getEndpoint();
      log.info("AWS SesClient endpoint: {}", endpoint);
      builder.endpointOverride(URI.create(endpoint));
    }
    return builder.build();
  }
